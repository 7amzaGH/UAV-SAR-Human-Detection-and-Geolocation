...
The trained weights for **AlienSight** (YOLOv8 `.pt` and `.onnx` formats) are currently **not publicly available**.

This decision is due to:
- ongoing research and potential publication
- file size constraints for GitHub
